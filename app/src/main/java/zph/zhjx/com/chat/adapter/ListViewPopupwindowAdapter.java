...
public class ListViewPopupwindowAdapter extends BaseAdapter{
    private Context mContext;
    private LayoutInflater mInflater;
    private List<People> mDatas;
    public ListViewPopupwindowAdapter(Context context, List<People> mDatas)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null)
        {
            ...
            convertView = mInflater.inflate(
                    R.layout.item_listview_popupwindow, parent, false);
            viewHolder.mImg = (ImageView) convertView
                    .findViewById(R.id.item_listview_popupwindow_image);
            viewHolder.mText = (TextView) convertView
                    .findViewById(R.id.item_listview_popupwindow_name);
